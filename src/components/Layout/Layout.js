...
function Layout() {
  ...
  return (
    <Typography component="div" className={classes.root}>
      ...
      <Typography component="div" className={classnames(classes.content, { [classes.contentShift]: layoutState.isSidebarOpened })}>
        <Typography component="div" className={classes.fakeToolbar} />
